...
- The 3 openwifi-sourced patches (0009-0011) have regen scripts. `util/regen_all_patches.sh` regenerates all of them. 0012 and 0014 are hand-maintained Theshire-local patches.
